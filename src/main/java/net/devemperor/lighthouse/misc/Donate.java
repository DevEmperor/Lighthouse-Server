...
import net.devemperor.lighthouse.main.WorldBorder;
                    ...
                    if (dest == null) {
                        ...
                        if (player.getName().equals(dest.getName())) {
                            ...
                            if (amount > player.getTotalExperience()) {
                                ...
                                // cannot call PlayerExpChangeEvent directly cause the -amount would be ignored
                                ScoreboardWorld.cfg.set(player.getUniqueId() + "." + ".exp", ScoreboardWorld.cfg.getLong(player.getUniqueId() + "." + ".exp") - amount);
                                ScoreboardWorld.cfg.set(dest.getUniqueId() + "." + ".exp", ScoreboardWorld.cfg.getLong(dest.getUniqueId() + "." + ".exp") + amount);
